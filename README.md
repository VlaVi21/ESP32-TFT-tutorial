...
## Зміст
- [1. Чому саме TFT_eSPI?](#1-чому-саме-tft_espi)
- [2. Схема підключення](#2-схема-підключення)
- [3. Додавання бібліотеки у Visual Studio Code](#3-додавання-бібліотеки-у-visual-studio-code)
- [4. Налаштування пінів](#4-налаштування-пінів)
- [5. Перевірка роботи (Hello World)](#5-перевірка-роботи-hello-world)
- [6. Приклади з бібліотеки](#6-приклади-з-бібліотеки)
- [7. Особистий досвід](#7-особистий-досвід)
- [8. Поширені проблеми](#8-поширені-проблеми)
...
![Схема підключення TFT дисплею до ESP32](images_2.0/Sh_TFT_V2(final).png)
...
---
**Якщо цей гайд допоміг — став ⭐ у репозиторії, щоб інші теж знайшли його швидше!**
